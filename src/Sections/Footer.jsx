  ...
  return (
    <>
      ...
      <footer className="text-center px-6 py-16 relative" style={{background:"#2d1f14"}}>
        ...
        <div className="pt-6" style={{fontFamily:"'Great Vibes', cursive", fontSize:"4rem", color:"#f5c380"}}>Ken & Mimi</div>
        <p className="text-xs tracking-widest uppercase mt-2 mb-8" style={{color:"rgba(253,246,238,0.4)"}}>April 9, 2026</p>
